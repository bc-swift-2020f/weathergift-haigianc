...
//  WeatherGift
//
//  Created by Claudine Haigian on 10/10/20.
...
extension LocationDetailViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.dailyWeater = weatherDetail.dailyWeatherData[indexPath.row]
        return cell
    }
...
extension LocationDetailViewController: CLLocationManagerDelegate{
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        geoCoder.reverseGeocodeLocation(currentLocation) { (placemarks, error) in
            ...
            //update weatherlocations[0] with current location so it can be used in updateUserInterface. get location only called when location index == 0
            let pageViewController = UIApplication.shared.windows.first!.rootViewController as! PageViewController
